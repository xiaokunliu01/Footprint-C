...
# fastqc
fastqc $1'_'1.fq.gz -o fastqc_R1r1/
fastqc $1'_'2.fq.gz -o fastqc_R1r1/
...
fastqc trimLk_R1r1/$1'_'trimLk3_2.fq.gz -o fastqc_R1r1/

# HiC-Pro
mkdir HiCPro_Analysis_R1r1/
mkdir HiCPro_Analysis_R1r1/data
mkdir HiCPro_Analysis_R1r1/data/$1'_'val_trimLk3
