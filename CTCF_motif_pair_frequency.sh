...
awk '{if($1!~/chr[CLMT]/ && $4!~/chr[CLMT]/ && $8!="no_adapterno_adapterno_adapter") print $0}' /mnt/disk1/6/lxk/private/DNase-C/220725_DNaseC_K562_FA_EGS,FA_0percentSDS_4,8ulDNase_30m_noHI_rtaq_S,L-link_liga16C4h_exo1h_gDNA50-150/fragment_Length_R1r4/DNaseC_K562_FA_UMI_rmdup.pair > DNaseC_K562_FA_UMI_rmdup_wlink_nochrCLMT.pair

awk '{print $1"\t"$2"\t"$3"\t"NR"\t"$10}' DNaseC_K562_FA_UMI_rmdup_wlink_nochrCLMT.pair | sort -k1,1 -k2,2n -S 9G > 1_sort.uppair
awk '{print $4"\t"$5"\t"$6"\t"NR"\t"$11}' DNaseC_K562_FA_UMI_rmdup_wlink_nochrCLMT.pair | sort -k1,1 -k2,2n -S 9G > 2_sort.downpair
...
awk -f /home/lxk/private/optionData/script/DNase-C/stat_noextend.awk pair_closet_CTCFmotif.txt > pair_closet_CTCFmotif.stat
...
awk -f /home/lxk/private/optionData/script/DNase-C/stat_noextend.awk HiTrAC_pair_closet_CTCFmotif.txt > HiTrAC_pair_closet_CTCFmotif.stat
