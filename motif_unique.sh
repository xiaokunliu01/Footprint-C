...
# DNaseC
closestBed -a DNaseC_K562_FA_UMI_sort_name.singlepair -b K562_hg38_motif_sort.bed -d -t all > DNaseC_K562_closest_motif.txt

sort -k1,1 -k2,2n -k3,3n -k4,4n -k5,5 -k6,6n -k7,7n -u --buffer-size=10% -T ./ --parallel=80 DNaseC_K562_closest_motif.txt > DNaseC_K562_closest_motif_u.txt

awk '{if($13==0) print $0}' DNaseC_K562_closest_motif_u.txt | groupBy -g 1,2,3,4 -c 6 -o min,max > DNaseC_K562_closest_motif_u_0_groupby.txt

awk '{if($13==0 && $6-$2>10 && $3-$7>10) print $0}' DNaseC_K562_closest_motif_u.txt | groupBy -g 1,2,3,4 -c 6 -o min,max

awk '{if($13==0 && $6-$2>10 && $3-$7>10) print $0}' DNaseC_K562_closest_motif_u.txt | groupBy -g 1,2,3,4 -c 6 -o min,max | awk '{if($6-$5<=20) print $0}' | wc -l
...
awk '{if($1!~/chr[CLMT]/ && $4!~/chr[CLMT]/) print $0}' /home/lxk/private/K562/DNaseC/public/HiTrAC/Hi-TrAC_K562_R1r1.bedpe > Hi-TrAC_K562_R1r1.pair
