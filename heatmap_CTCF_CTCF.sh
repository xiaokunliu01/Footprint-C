...
awk '{print $1"\t"$2"\t"$3"\t"$7"\t"$10}' /mnt/disk1/6/lxk/private/DNase-C/Total_DNaseC_K562/DNaseC_K562_total_UMI_wlink_nochrCLMT.pairs | sort -k1,1 -k2,2n --buffer-size=40% -T ./ --parallel=80 > DNaseC_K562_sort.uppair
awk '{print $4"\t"$5"\t"$6"\t"$7"\t"$11}' /mnt/disk1/6/lxk/private/DNase-C/Total_DNaseC_K562/DNaseC_K562_total_UMI_wlink_nochrCLMT.pairs | sort -k1,1 -k2,2n --buffer-size=40% -T ./ --parallel=80 > DNaseC_K562_sort.downpair


closestBed -a DNaseC_K562_sort.uppair -b /mnt/disk4/public/RefBed/CTCF/K562_CTCF_RAD21_DNase.motif -d -t first > uppair_closest_motif.txt
closestBed -a DNaseC_K562_sort.downpair -b /mnt/disk4/public/RefBed/CTCF/K562_CTCF_RAD21_DNase.motif -d -t first > downpair_closest_motif.txt
...
awk -f /home/lxk/private/optionData/script/DNase-C/stat_noextend.awk DNaseC_K562_FA_pair_closet_motif.txt > DNaseC_K562_FA_pair_closet_motif.stat


awk '{if(($14==0) && ($28==0) && ($23!=$9)) print $6"\t"$7"\t"$8"\t"$9"\t"$10"\t"$11"\t"$12"\t"$13"\t"$20"\t"$21"\t"$22"\t"$23"\t"$24"\t"$25"\t"$26"\t"$27"\t"$5$19}' DNaseC_K562_FA_pair_closet_motif.txt > CTCF_CTCF_motif_pair.txt
...
mkdir $i
cd $i
closestBed -a ../DNaseC_K562_sort.uppair -b /mnt/disk1/6/lxk/private/DNase-C/DNaseC_paper/dimer/motif/K562_$i'.'motif -d -t first > uppair_closest_motif.txt
closestBed -a ../DNaseC_K562_sort.downpair -b /mnt/disk1/6/lxk/private/DNase-C/DNaseC_paper/dimer/motif/K562_$i'.'motif -d -t first > downpair_closest_motif.txt
...
cd CTCF
cut -f1-14 DNaseC_K562_FA_pair_closet_motif.txt > up.bed
cut -f15-28 DNaseC_K562_FA_pair_closet_motif.txt > down.bed
cd ..
