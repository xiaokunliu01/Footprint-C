...
mkdir $i
cd $i
closestBed -a /home/lxk/private/K562/DNaseC/Dimerization/all_pair/DNaseC_K562_FA_sort.uppair -b ../motif/K562_$i'.'motif -d -t first > uppair_closest_motif.txt
closestBed -a /home/lxk/private/K562/DNaseC/Dimerization/all_pair/DNaseC_K562_FA_sort.downpair -b ../motif/K562_$i'.'motif -d -t first > downpair_closest_motif.txt
...
rm downpair_closest_motif.txt
 paste uppair_closest_motif_sort.txt downpair_closest_motif_sort.txt > DNaseC_K562_FA_pair_closet_motif.txt
rm uppair_closest_motif_sort.txt
rm downpair_closest_motif_sort.txt
awk -f /mnt/disk2-0/lxk/private/optionData/script/DNase-C/stat_noextend_wlink.awk DNaseC_K562_FA_pair_closet_motif.txt > DNaseC_K562_FA_pair_closet_motif.stat
cd ..
done
...
do
cd $i
cut -f6-14 DNaseC_K562_FA_pair_closet_motif.txt > up.bed
cut -f20-28 DNaseC_K562_FA_pair_closet_motif.txt > down.bed
cd ..
done
#mkdir CTCF
#cd CTCF
#cut -f1-14 /home/lxk/private/K562/DNaseC/Dimerization/all_pair/230203/CTCF/DNaseC_K562_FA_pair_closet_motif.txt > up.bed
#cut -f15-28 /home/lxk/private/K562/DNaseC/Dimerization/all_pair/230203/CTCF/DNaseC_K562_FA_pair_closet_motif.txt > down.bed
#cd ..
...
#mkdir $i
#cd $i
#cut -f6-14 /home/lxk/private/K562/DNaseC/Dimerization/all_pair/230203/$i/DNaseC_K562_FA_pair_closet_motif.txt > up.bed
#cut -f20-28 /home/lxk/private/K562/DNaseC/Dimerization/all_pair/230203/$i/DNaseC_K562_FA_pair_closet_motif.txt > down.bed
#cd ..
#done
...
awk '{if(($3-$2<=60) && ($17-$16<=60) && ($14==0) && ($28==0) && ($23!=$9)) print $6"\t"$7"\t"$8"\t"$9"\t"$10"\t"$11"\t"$12"\t"$13"\t"$20"\t"$21"\t"$22"\t"$23"\t"$24"\t"$25"\t"$26"\t"$27"\t"$5$19}' /mnt/disk1/6/lxk/private/K562/DNaseC/Dimerization/all_pair/230203/CTCF/DNaseC_K562_FA_pair_closet_motif.txt > CTCF_CTCF_motif_pair_length60bp.txt; awk '{if($1==$9 && $10-$2>320) print $0}' CTCF_CTCF_motif_pair_length60bp.txt > CTCF_CTCF_motif_pair_length60bp_cis_dis320bp.txt; sort -k4,4n -k12,12n -S 9G CTCF_CTCF_motif_pair_length60bp_cis_dis320bp.txt | groupBy -g 1-16 -c 17,17 -o count,freqdesc > CTCF_CTCF_motif_pair_length60bp_cis_dis320bp_groupby.txt

awk '{if(($3-$2<=60) && ($17-$16<=60) && ($14==0) && ($28==0) && ($23!=$9)) print $6"\t"$7"\t"$8"\t"$9"\t"$10"\t"$11"\t"$12"\t"$13"\t"$20"\t"$21"\t"$22"\t"$23"\t"$24"\t"$25"\t"$26"\t"$27"\t"$5$19}' /mnt/disk1/6/lxk/private/K562/DNaseC/Dimerization/all_pair/230203/KLF1/DNaseC_K562_FA_pair_closet_motif.txt > KLF1_KLF1_motif_pair_length60bp.txt; awk '{if($1==$9 && $10-$2>320) print $0}' KLF1_KLF1_motif_pair_length60bp.txt > KLF1_KLF1_motif_pair_length60bp_cis_dis320bp.txt; sort -k4,4n -k12,12n -S 9G KLF1_KLF1_motif_pair_length60bp_cis_dis320bp.txt | groupBy -g 1-16 -c 17,17 -o count,freqdesc > KLF1_KLF1_motif_pair_length60bp_cis_dis320bp_groupby.txt

awk '{if(($3-$2<=60) && ($17-$16<=60) && ($14==0) && ($28==0) && ($23!=$9)) print $6"\t"$7"\t"$8"\t"$9"\t"$10"\t"$11"\t"$12"\t"$13"\t"$20"\t"$21"\t"$22"\t"$23"\t"$24"\t"$25"\t"$26"\t"$27"\t"$5$19}' /mnt/disk1/6/lxk/private/K562/DNaseC/Dimerization/all_pair/230203/MAZ/DNaseC_K562_FA_pair_closet_motif.txt > MAZ_MAZ_motif_pair_length60bp.txt; awk '{if($1==$9 && $10-$2>320) print $0}' MAZ_MAZ_motif_pair_length60bp.txt > MAZ_MAZ_motif_pair_length60bp_cis_dis320bp.txt; sort -k4,4n -k12,12n -S 9G MAZ_MAZ_motif_pair_length60bp_cis_dis320bp.txt | groupBy -g 1-16 -c 17,17 -o count,freqdesc > MAZ_MAZ_motif_pair_length60bp_cis_dis320bp_groupby.txt

awk '{if(($3-$2<=60) && ($17-$16<=60) && ($14==0) && ($28==0) && ($23!=$9)) print $6"\t"$7"\t"$8"\t"$9"\t"$10"\t"$11"\t"$12"\t"$13"\t"$20"\t"$21"\t"$22"\t"$23"\t"$24"\t"$25"\t"$26"\t"$27"\t"$5$19}' /mnt/disk1/6/lxk/private/K562/DNaseC/Dimerization/all_pair/230203/ZNF143/DNaseC_K562_FA_pair_closet_motif.txt > ZNF143_ZNF143_motif_pair_length60bp.txt; awk '{if($1==$9 && $10-$2>320) print $0}' ZNF143_ZNF143_motif_pair_length60bp.txt > ZNF143_ZNF143_motif_pair_length60bp_cis_dis320bp.txt; sort -k4,4n -k12,12n -S 9G ZNF143_ZNF143_motif_pair_length60bp_cis_dis320bp.txt | groupBy -g 1-16 -c 17,17 -o count,freqdesc > ZNF143_ZNF143_motif_pair_length60bp_cis_dis320bp_groupby.txt

awk '{if(($3-$2<=60) && ($17-$16<=60) && ($14==0) && ($28==0) && ($23!=$9)) print $6"\t"$7"\t"$8"\t"$9"\t"$10"\t"$11"\t"$12"\t"$13"\t"$20"\t"$21"\t"$22"\t"$23"\t"$24"\t"$25"\t"$26"\t"$27"\t"$5$19}' /mnt/disk1/6/lxk/private/K562/DNaseC/Dimerization/all_pair/230203/SP1/DNaseC_K562_FA_pair_closet_motif.txt > SP1_SP1_motif_pair_length60bp.txt; awk '{if($1==$9 && $10-$2>320) print $0}' SP1_SP1_motif_pair_length60bp.txt > SP1_SP1_motif_pair_length60bp_cis_dis320bp.txt; sort -k4,4n -k12,12n -S 9G SP1_SP1_motif_pair_length60bp_cis_dis320bp.txt | groupBy -g 1-16 -c 17,17 -o count,freqdesc > SP1_SP1_motif_pair_length60bp_cis_dis320bp_groupby.txt

awk '{if(($3-$2<=60) && ($17-$16<=60) && ($14==0) && ($28==0) && ($23!=$9)) print $6"\t"$7"\t"$8"\t"$9"\t"$10"\t"$11"\t"$12"\t"$13"\t"$20"\t"$21"\t"$22"\t"$23"\t"$24"\t"$25"\t"$26"\t"$27"\t"$5$19}' DNaseC_K562_FA_pair_closet_motif.txt > KLF11_KLF11_motif_pair_length60bp.txt; awk '{if($1==$9 && $10-$2>320) print $0}' KLF11_KLF11_motif_pair_length60bp.txt > KLF11_KLF11_motif_pair_length60bp_cis_dis320bp.txt; sort -k4,4n -k12,12n -S 9G KLF11_KLF11_motif_pair_length60bp_cis_dis320bp.txt | groupBy -g 1-16 -c 17,17 -o count,freqdesc > KLF11_KLF11_motif_pair_length60bp_cis_dis320bp_groupby.txt
